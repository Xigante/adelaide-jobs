...
Os quatro têm três espaços em branco de propósito:
...
E no `CV-3-Escritorio` tem mais um:
`[ MANTENHA SÓ O QUE VOCÊ CONSEGUE EXPLICAR NUMA ENTREVISTA ]`. Apague dessa
linha tudo que você não conseguiria conversar a respeito, em inglês, com
